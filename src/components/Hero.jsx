  ...
  return (
    <>
      <div className="hero w-full h-[90vh] relative text-white flex flex-col justify-center items-center md:items-center">
        <img
          className=" w-full h-[90vh] object-cover object-top absolute left-0 top-0 -z-10 brightness-[50%] mb-5"
        ...
        <div className="answers flex flex-col md:flex-row justify-center items-center text-xl text-white">
          <div className="1 mt-10 mx-10 bg-[#ed2846]  w-60 rounded-full cursor-pointer h-16 flex justify-center items-center text-center  opacity-100 hover:opacity-80">
            <Link to="/plans">Plans</Link>
          </div>
          <div className="2 mt-10 mx-10 bg-[#ed2846]  w-60 h-16 rounded-full cursor-pointer flex justify-center items-center text-center opacity-100 hover:opacity-80">
      ...
      <div className="quote bg-[#ed2846]  font-bold flex justify-center items-center  md:w-full h-[30vh] text-white text-3xl md:text-6xl text-center py-10 md:py-[20vh]">
