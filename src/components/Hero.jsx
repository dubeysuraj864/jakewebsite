  ...
  return (
    <>
      <div className="hero w-full h-[90vh] md:h-[98vh] relative text-white flex flex-col justify-center items-center md:items-center">
        ...
        <div
          data-aos="fade-left"
          className="name font-bold text-7xl md:text-9xl text-center flex flex-col justify-center items-center text-[#e5ad06] clip-text "
        >
          <div>
        ...
        <div data-aos="fade-up" className="text-3xl py-5">
          Online Coaching
        </div>
        <div
          data-aos="fade-up-right"
          className="answers flex flex-col md:flex-row justify-center items-center text-xl text-white"
        >
          <div className="1 mt-10 mx-10 bg-[#e5ad06]  md:w-60 rounded-full cursor-pointer w-44 h-12 md:h-16 flex justify-center items-center text-center  opacity-100 hover:opacity-80">
            <Link to="/plans">Plans</Link>
          </div>
          <div className="2 mt-10 mx-10 bg-[#e5ad06]  md:w-60 rounded-full cursor-pointer w-44 h-12 md:h-16 flex justify-center items-center text-center  opacity-100 hover:opacity-80">
      ...
      <div className="quote bg-black  font-bold flex justify-center items-center  md:w-full h-[20vh] px-4 text-white text-3xl md:text-6xl text-center py-5 md:py-[15vh]">
        <div data-aos="zoom-in"> Find your goal...focus...and just do it!</div>
      </div>
    </>
  );
}
