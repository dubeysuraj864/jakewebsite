...
function Faq() {
  return (
    <div className="bg-[#006c61] text-white py-20 overflow-hidden">
      <div className="faq ">
        <div
          data-aos="flip-left"
          className="heading  text-center font-bold flex justify-center text-7xl md:text-9xl"
        >
          What do <br /> you get?
        </div>
      </div>
      <div
        data-aos="fade-right"
        className="flex flex-col md:flex-row justify-center items-center mt-10"
      >
        <div className="left mx-5 md:mx-20">
          ...
          <div data-aos="fade-right" className="2 my-10">
        ...
        <div data-aos="fade-left" className="right mx-5 md:mx-20">
      ...
      <div className="why my-20 md:my-5">
        <div
          data-aos="flip-up"
          className="heading font-bold flex justify-center text-7xl md:text-9xl text-center"
        >
          Why choose <br />
          online coaching?
        </div>
        ...
        <div className=" flex flex-col md:flex-row justify-around items-center mt-10">
          <div data-aos="zoom-in" className="left mx-5 md:m-10">
            <img
          ...
          <div
            ...
            className="right w-[90vw] my-10 md:w-[40vw] px-5 mr-5 text-xl leading-8"
          >
            ...
            helps me encourage you to be the best version of you . <br /> <br />{" "}
            My online coaching is an absolute when it comes to reaching your
            full potential within fitness and obtaining your goals. My coaching
